    ...
    return [
        html.Header(children=[
            ...
            html.Div(className="toolbar", children=[
                ...
                html.Label("Área de Interesse:", className="sub", htmlFor="area-select"),
                dcc.Dropdown(
                    id="area-select",
                    options=areas,
                    value="all",
                ...
                html.Label("ID do Dispositivo:", className="sub", htmlFor="device-select"),
                dcc.Dropdown(
                    id="device-select",
                    options=devices,
                    value="all",
